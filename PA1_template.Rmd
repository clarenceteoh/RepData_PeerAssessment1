...
plot(weekday_steps_interval$interval, weekday_steps_interval$steps, type = "l", main = "Comparison of the Average Number of Steps\n between Weekdays and Weekends", xlab = "Interval", ylab = "Frequency", col = "red")
